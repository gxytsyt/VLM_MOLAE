...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls):
        tokenizer = BertTokenizer.from_pretrained("/data/yangyp/LaVIN-video-Q-former/bert_base_uncased")
    ...
    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2):
        encoder_config = BertConfig.from_pretrained("/data/yangyp/LaVIN-video-Q-former/bert_base_uncased")
